...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Registros.</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Ingrensa los campos para iniciar sesión.</p>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="input-group mb-3">
        <input placeholder="Comfirmar Contraseña" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
            <div class="input-group-append">
                <div class="input-group-text">
                <span class="fas fa-lock"></span>
                </div>
        ...
        <div class="row">
          <div class="col-6">
          <a href="/home"><button type="button" class="btn btn-primary btn-block">Volver</button></a>
          </div>
          <!-- /.col -->
          <div class="col-6">
